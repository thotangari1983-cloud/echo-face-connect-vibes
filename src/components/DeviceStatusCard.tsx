...
export function DeviceStatusCard() {
  ...
  return (
    <div className={`glass p-4 flex items-center gap-4 ${d.connected ? "neon-border" : ""}`}>
      <div className={`h-10 w-10 rounded-lg flex items-center justify-center ${d.connected ? "bg-success/15 text-success animate-pulse-glow" : "bg-destructive/15 text-destructive"}`}>
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2">
          ...
          <span className={`text-xs uppercase tracking-widest font-semibold ${d.connected ? "text-success" : "text-destructive"}`}>
